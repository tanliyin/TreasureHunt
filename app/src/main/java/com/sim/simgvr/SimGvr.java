 ...
 */
public class SimGvr extends GvrActivity implements GvrView.StereoRenderer {
    ...
    private static final float YAW_LIMIT = 0.06f;
    private static final float PITCH_LIMIT = 0.06f;
    ...
    public void initializeGvrView() {
        setContentView(R.layout.activity_sim_gvr);
    ...
    public void onCardboardTrigger() {
        ...
        Log.d("tanliyin", "isLookingAtObject()="+isLookingAtObject());
        if (isLookingAtObject()) {
            Log.d("tanliyin", "is looking at");
